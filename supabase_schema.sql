...
CREATE TABLE IF NOT EXISTS px_messages (
  ...
  wa_message_timestamp TEXT,
  wa_message_status TEXT,
  wa_media_id TEXT,
  wa_media_mime_type TEXT,
  wa_media_sha256 TEXT,
  wa_media_caption TEXT,
  wa_media_filename TEXT,
  wa_media_storage_bucket TEXT,
  wa_media_storage_path TEXT,
  wa_media_storage_status TEXT,
  wa_media_storage_error TEXT,
  wa_business_phone_number_id TEXT,
  wa_business_display_phone TEXT,
  wa_from_phone TEXT,
  wa_to_phone TEXT,
  ai_suggestion TEXT,
  final_response TEXT,
